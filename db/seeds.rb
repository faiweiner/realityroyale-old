...
show1ep1 = Episode.create(season_id: show1.id, air_date: '05/01/2015', survivor_count: 18, published: true, aired: false)
show1ep2 = Episode.create(season_id: show1.id, air_date: '12/01/2015', survivor_count: 15, published: true, aired: false)
show1ep3 = Episode.create(season_id: show1.id, air_date: '19/01/2015', survivor_count: 13, published: true, aired: false)
show1ep4 = Episode.create(season_id: show1.id, air_date: '26/01/2015', survivor_count: 11, published: true, aired: false)
show1ep5 = Episode.create(season_id: show1.id, air_date: '2/02/2015', survivor_count: 8, published: true, aired: false)
show1ep6 = Episode.create(season_id: show1.id, air_date: '9/02/2015', survivor_count: 5, published: true, aired: false)
show1ep7 = Episode.create(season_id: show1.id, air_date: '16/02/2015', survivor_count: 4, published: true, aired: false)
show1ep8 = Episode.create(season_id: show1.id, air_date: '23/02/2015', survivor_count: 3, published: true, aired: false)
show1ep9 = Episode.create(season_id: show1.id, air_date: '2/03/2015', survivor_count: 2, published: true, aired: false)
show1ep10 = Episode.create(season_id: show1.id, air_date: '9/03/2015', survivor_count: 1, published: true, aired: false)
